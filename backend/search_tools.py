...
class CourseSearchTool(Tool):
    ...
    def execute(self, query: str, course_name: Optional[str] = None, lesson_number: Optional[int] = None) -> str:
        ...
        # Reset sources before each search to avoid stale data leaking
        self.last_sources = []
    ...
    def _format_results(self, results: SearchResults) -> str:
        ...
        for doc, meta in zip(results.documents, results.metadata):
            ...
            sources.append({"label": label, "link": lesson_link})
...
class CourseOutlineTool(Tool):
    ...
    def get_tool_definition(self) -> Dict[str, Any]:
        return {
            ...
            "description": "Get the full outline of a course: course title, course link, and all lessons with their numbers and titles",
            "input_schema": {
                "type": "object",
                "properties": {
                    "course_title": {
                        "type": "string",
                        "description": "Course title or partial name to look up (e.g. 'MCP', 'Introduction to AI')"
                    }
                },
